...
// const allBooksWithRating = require('./../../src/routes/allBooksWithRating');

// describe('GET route /allBooksWithRating', () => {
//   it('should return an object', async () => {
//     const url = 'localhost:3000/booksWithRatings';
//     const responseLocalServer = await axios.get(url);
//     console.log(responseLocalServer);
//   });
// });
...
describe('the GET /booksWithRating route', () => {
  const mockResponse = {
    'J K Rowling': [{
  ...
  beforeAll(() => {
    ...
    getMock.mockImplementation(() => mockResponse);
  });
  afterAll(() => {
    getMock.mockRestore();
  });
